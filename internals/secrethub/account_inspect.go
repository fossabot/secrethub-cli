...
func (cmd *AccountInspectCommand) Register(c *cobra.Command) {
	command := &cobra.Command{
		Use:   "inspect",
		Short: "Show the details of your SecretHub account.",
		RunE:  cmd.Run,
	}
...
func (cmd *AccountInspectCommand) Run(_ *cobra.Command, args []string) error {
