...
func (cmd *RmCommand) Register(c *cobra.Command) {
	command := &cobra.Command{
		Use:     "rm",
		Aliases: []string{"remove"},
		Short:   "Remove a directory, secret or version.",
		RunE:    cmd.Run,
	}
	command.Flags().BoolVarP(&cmd.recursive, "recursive", "r", false, "Remove directories and their contents recursively.")
	registerForceFlag(command, &cmd.force)
...
func (cmd *RmCommand) Run(_ *cobra.Command, args []string) error {
